  ...
  init: function (start) {
    if (start != 0){
      ...
      if (i !== -1) {
       ...
       S.UI.simulate('|#countdown 3||祝|最最可爱的小布布|生日快乐！|祝你|幸福健康|前途光明|愿今后也像过去的|7305天一样|健康快乐|年年有今日|岁岁有今朝|生日快乐丫！！！|#icon heart|#icon heart-empty|#icon heart');
      }
...
S.Dot = function (x, y) {
  ...
  this.c = new S.Color(245, 172, 183, this.p.a);
